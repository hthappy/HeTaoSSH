...
|---|---|
| `HeTaoSSH_0.5.2_x64-setup.exe` | **Windows Installer (Recommended)** / Windows 标准安装包（推荐） |
| `HeTaoSSH_0.5.2_x64.msi` | Windows MSI Installer / Windows MSI 安装包（企业部署） |
| `HeTaoSSH_0.5.2_aarch64.dmg` | macOS Apple Silicon Installer / macOS M1/M2/M3 安装包 |
